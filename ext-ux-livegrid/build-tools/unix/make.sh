...
if [ "$#" -eq 1 ] then
	...
	livegrid_file_list_core="${TP}src/GridPanel.js+${TP}src/GridView.js+${TP}src/JsonReader.js+${TP}src/RowSelectionModel.js+${TP}src/Store.js+${TP}src/CheckboxSelectionModel.js"
