...
:process
set tp=..\..\
set livegrid_file_list_core=%tp%src\GridPanel.js+%tp%src\GridView.js+%tp%src\JsonReader.js+%tp%src\RowSelectionModel.js+%tp%src\Store.js+%tp%src\CheckboxSelectionModel.js
